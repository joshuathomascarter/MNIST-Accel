...
module soc_top_v2 #(
  ...
  axi_crossbar #(
    ...
    .m_awlen   ({8'd0,       8'd0,       l1_m_axi_awlen}),
    ...
    .m_arlen   ({8'd0,       8'd0,       l1_m_axi_arlen}),
  ...
  // =========================================================================
  // Sub-address decode: s_awaddr[2][15:8]
  ...
  always_ff @(posedge clk_core or negedge rst_core_n) begin
    if (!rst_core_n) begin
      ...
      if (s_awvalid[2] && s_awready[2]) begin
        periph_aw_sel_r  <= s_awaddr[2][15:8];
      ...
      if (s_arvalid[2] && s_arready[2]) begin
        periph_ar_sel_r  <= s_araddr[2][15:8];
  ...
  // =========================================================================
  // ===== SECTION 7: Slave 4 — L2 Cache → DRAM =============================
  // =========================================================================
  ...
  l2_cache_top #(
    ...
    // Upstream: crossbar slave port 4
    .s_axi_awvalid (s_awvalid[4]),  .s_axi_awready (s_awready[4]),
    .s_axi_awaddr  (s_awaddr[4]),   .s_axi_awid    (s_awid[4]),
    .s_axi_awlen   (s_awlen[4]),   .s_axi_awsize  (3'b010),  .s_axi_awburst (2'b01),
    .s_axi_wvalid  (s_wvalid[4]),   .s_axi_wready  (s_wready[4]),
    .s_axi_wdata   (s_wdata[4]),    .s_axi_wstrb   (s_wstrb[4]),  .s_axi_wlast (s_wlast[4]),
    .s_axi_bvalid  (s_bvalid[4]),   .s_axi_bready  (s_bready[4]),
    .s_axi_bresp   (s_bresp[4]),    .s_axi_bid     (s_bid[4]),
    .s_axi_arvalid (s_arvalid[4]),  .s_axi_arready (s_arready[4]),
    .s_axi_araddr  (s_araddr[4]),   .s_axi_arid    (s_arid[4]),
    .s_axi_arlen   (s_arlen[4]),   .s_axi_arsize  (3'b010),  .s_axi_arburst (2'b01),
    .s_axi_rvalid  (s_rvalid[4]),   .s_axi_rready  (s_rready[4]),
    .s_axi_rdata   (s_rdata[4]),    .s_axi_rresp   (s_rresp[4]),
    .s_axi_rid     (s_rid[4]),      .s_axi_rlast   (s_rlast[4]),

    // Downstream: to DRAM controller
    .m_axi_awvalid (l2_m_axi_awvalid), .m_axi_awready (l2_m_axi_awready),
    .m_axi_awaddr  (l2_m_axi_awaddr),  .m_axi_awid    (l2_m_axi_awid),
    .m_axi_awlen   (l2_m_axi_awlen),   .m_axi_awsize  (l2_m_axi_awsize),
    .m_axi_awburst (l2_m_axi_awburst),
    .m_axi_wvalid  (l2_m_axi_wvalid),  .m_axi_wready  (l2_m_axi_wready),
    .m_axi_wdata   (l2_m_axi_wdata),   .m_axi_wstrb   (l2_m_axi_wstrb),
    .m_axi_wlast   (l2_m_axi_wlast),
    .m_axi_bvalid  (l2_m_axi_bvalid),  .m_axi_bready  (l2_m_axi_bready),
    .m_axi_bresp   (l2_m_axi_bresp),   .m_axi_bid     (l2_m_axi_bid),
    .m_axi_arvalid (l2_m_axi_arvalid), .m_axi_arready (l2_m_axi_arready),
    .m_axi_araddr  (l2_m_axi_araddr),  .m_axi_arid    (l2_m_axi_arid),
    .m_axi_arlen   (l2_m_axi_arlen),   .m_axi_arsize  (l2_m_axi_arsize),
    .m_axi_arburst (l2_m_axi_arburst),
    .m_axi_rvalid  (l2_m_axi_rvalid),  .m_axi_rready  (l2_m_axi_rready),
    .m_axi_rdata   (l2_m_axi_rdata),   .m_axi_rresp   (l2_m_axi_rresp),
    .m_axi_rid     (l2_m_axi_rid),     .m_axi_rlast   (l2_m_axi_rlast),
