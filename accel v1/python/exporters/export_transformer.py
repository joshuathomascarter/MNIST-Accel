...
def create_sparse_mask(shape: Tuple[int, int], sparsity_pct: float, 
                       block_size: int = 8, seed: int = 42) -> np.ndarray:
    """
...
def create_transformer_qkv_weights(d_model: int = 128, d_head: int = 64, 
