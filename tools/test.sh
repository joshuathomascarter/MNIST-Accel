#!/bin/bash
# =============================================================================
# test.sh - Unified Test Runner for ACCEL-v1
# =============================================================================
# Updated: December 4, 2025
# Structure: testbench/sv/, testbench/cpp/, testbench/cocotb/
# =============================================================================
...
TB_SV_DIR="$PROJECT_ROOT/testbench/sv"
TB_CPP_DIR="$PROJECT_ROOT/testbench/cpp"
...
# =============================================================================
# Test: Python PYNQ Drivers (simulation mode)
# =============================================================================
test_python() {
    print_header "Test 1: Python PYNQ Drivers"
    
    cd "$PROJECT_ROOT/accel/python/host"
    
    print_info "Running Python driver tests..."
    python3 accel.py 2>&1 | tail -5
    
    if [ $? -eq 0 ]; then
        print_success "Python driver tests passed"
    else
