...
// =============================================================================
constexpr uint32_t REG_LAYER_TOTAL     = 0xE0;  // R/W: total layers [7:0]
constexpr uint32_t REG_LAYER_CURRENT   = 0xE4;  // R/W: current layer index [7:0]
constexpr uint32_t REG_LAYER_CONFIG    = 0xE8;  // R/W: [0]=pool_en
constexpr uint32_t REG_LAYER_OUT_DIM   = 0xEC;  // R/W: [31:16]=out_h, [15:0]=out_w
constexpr uint32_t REG_LAYER_STATUS    = 0xF0;  // RO/W1C: [0]=layer_done, [1]=last_layer_done
...
namespace layer_status {
    constexpr uint32_t LAYER_DONE_BIT      = (1 << 0);  // R/W1C: Layer complete
    constexpr uint32_t LAST_LAYER_DONE_BIT = (1 << 1);  // R/W1C: Final layer → DDR done
}

namespace layer_config {
    constexpr uint32_t POOL_EN_BIT     = (1 << 0);  // RW: Enable 2×2 max pooling
}

// =============================================================================
// Hardware Constants (16×16 Systolic Array)
// =============================================================================
constexpr uint32_t SYSTOLIC_SIZE       = 16;        // PE array dimension
constexpr uint32_t BLOCK_SIZE          = SYSTOLIC_SIZE * SYSTOLIC_SIZE;  // 256 elements
