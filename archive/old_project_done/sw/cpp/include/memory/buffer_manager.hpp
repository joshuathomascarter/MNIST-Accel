...
// RELATIONSHIP TO RTL
// ===================
//   act_buffer.sv   → bank_sel_wr / bank_sel_rd  (2 banks, TM=16 wide)
//   wgt_buffer.sv   → bank_sel_wr / bank_sel_rd  (2 banks, TN=16 wide)
//   output_accumulator.sv → bank_sel, tile_done   (2 banks, 256 accumulators)
...
constexpr uint32_t TILE_DIM        = 16;        // Systolic array dimension
constexpr uint32_t TILE_ELEMENTS   = TILE_DIM * TILE_DIM;  // 256
constexpr uint32_t TILE_BYTES_INT8 = TILE_ELEMENTS;        // 256 bytes per tile
