...
// 16×16 weight-stationary systolic array, and prints the prediction.
//
// Two modes:
...
//   ./run_mnist_inference --bsr data/bsr_export_16x16  # BSR export dir
...
static void printUsage(const char* prog) {
    std::fprintf(stderr,
        ...
        "  --bsr DIR         BSR export directory (default: data/bsr_export_16x16)\n"
...
static int runHardware(const Options& opts) {
    std::fprintf(stdout, "\n=== MNIST Hardware Inference (16x16 Systolic Array) ===\n\n");
