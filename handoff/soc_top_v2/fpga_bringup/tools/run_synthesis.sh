...
#   - Vivado install with support for xc7z020clg400-1 (legacy PYNQ-Z2 handoff)
#
# OUTPUTS:
...
if [[ $VIVADO_EXIT -eq 0 ]]; then
    echo "Next: use this only for the legacy PYNQ-Z2 handoff flow, not the current ZCU104 path."
fi
